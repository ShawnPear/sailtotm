...
import com.yasyl.sailtotm.exception.user.IdNotSameException;
...
import static com.yasyl.sailtotm.constant.MessageConstant.OPE_ID_NOT_SAME_ERROR;
...
public class UserIdValidationAspect {
    ...
    @Pointcut("@annotation(com.yasyl.sailtotm.annotation.CheckUserId)") // 定义切点，拦截带有 @CheckUserId 注解的方法
